...
## Project Structure
    ...
    ├── testwendeployment_d_39463  # Django project configurations
...
1. Clone this repo and `cd testwendeployment_d_39463`
...
2. Clone this repo and `cd testwendeployment_d_39463`
